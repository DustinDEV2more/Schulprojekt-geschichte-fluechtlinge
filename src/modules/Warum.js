    ...
    return ( <div className="WarumPage" data-aos="fade-up">
        <div className="c box">
            ...
            <h3>Warum wollten die Menschen auswandern?</h3>
                <p>Die ersten deutschen Auswanderer wurden von religiösen, politischen oder wirtschaftlichen Gründen angetrieben. Religiöse Splittergruppen erhofften sich zum Beispiel im "Land der unbegrenzten Möglichkeiten" mehr Religionsfreiheit. Viele politisch Aktive hatten nach der gescheiterten Revolution im Jahre 1848 die Hoffnung auf ein demokratisches Deutschland verloren und verließen deshalb die Heimat.</p>
